...
// }
  ...
  return (
    ...
    <button  type="button" onClick={() => props.button(2)}class="btn btn-danger btn-lg" style={{width: "110px"}}>Low</button>
    <button  type="button" onClick={() => props.button(3)}class="btn btn-success btn-lg"style={{width: "110px"}}>Runnable</button>
    <button  type="button" onClick={() => props.button(4)} class="btn btn-primary btn-lg"style={{width: "110px"}}>High</button>
    </div>
  );
};
